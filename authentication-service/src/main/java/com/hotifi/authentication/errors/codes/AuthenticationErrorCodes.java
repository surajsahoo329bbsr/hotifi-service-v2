package com.hotifi.authentication.errors.codes;
...
public class AuthenticationErrorCodes extends ErrorCodes {
    ...
    public static final ErrorCode UNEXPECTED_EMAIL_OTP_ERROR = new ErrorCode("01", Collections.singletonList(getMessage("UNEXPECTED_EMAIL_OTP_ERROR", AuthenticationErrorMessages.UNEXPECTED_EMAIL_OTP_ERROR)), 400);
